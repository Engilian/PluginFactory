...
///
class IPFactoryPluginController: public ISubPlugin
{
protected:
    ///
    /// \brief Constructor
...
public:
    ...
    ///
    virtual QList<SubPlugin> creators( const QString &interface ) const = 0;
...
public:
    ...
    ///
    virtual QList<FactoryPlugin> plugins() const = 0;
};
